		...
		<script>
			...
			let myChart = new Chart(ctx, {
				...
				data: {
					...
					datasets: [{
						label: 'Cantitatea in tone a recoltei de secara din Republica Moldova',
				...
				options: {
					...
					plugins: {
						title: {
							display: true,
							text: 'Cantitatea in tone a recoltei de secara din Republica Moldova'
						}
					}
				}
			});
			...
			let myChart2 = new Chart(ctx2, {
				...
				options: {
					...
					plugins: {
						title: {
							display: true,
							text: 'Pretul în lei/kg de secara din Republica Moldova'
						}
					}
				}
			});
			...
			let myChart3 = new Chart(ctx3, {
				...
				data: {
					labels: ['2022', '2021','2020','2019', '2018', '2017', '2016'],
					datasets: [{
						label: 'Numarul de tone de secara exportate de furnizorul VadalexAgro',
